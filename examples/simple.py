...
class simple(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "CyberEther Demo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CyberEther Demo")
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_throttle_0, 0), (self.cyber_ether_sink_0, 0))
        self.connect((self.soapy_limesdr_source_0, 0), (self.blocks_throttle_0, 0))
...
def main(top_block_cls=simple, options=None):
